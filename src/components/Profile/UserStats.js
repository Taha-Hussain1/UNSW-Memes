...
function UserStats() {
  ...
  return (
      <>
        <Typography variant="h5" style={{ color: currentMode === "dark" ? "white" : "black" }}>User statistics</Typography>
        <p style={{ color: currentMode === "dark" ? "white" : "black" }}>Involvement rate: {(involvementRate * 100).toFixed(2)}%</p>
        <Scatter
            data={{
              datasets: [
                {
