...
function Message({
  ...
  return (
      <ListItem key={messageId} style={{ width: '100%', color: currentMode === "dark" ? "white" : "black" }}>
        {message && (
            <>
              <ListItemAvatar>
                <Avatar
              ...
              >
                <ListItemText
                    style={{ fontFamily: 'inherit', color: currentMode === "dark" ? "white" : "black" }}
                    primary={(
                        <>
                          <span>{fullName}</span>
                    ...
                    secondary={(
                        <div>
                          <pre style={{ fontFamily: 'inherit', color: currentMode === "dark" ? "white" : "black" }} >{message}</pre>
                        </div>
                    )}
                />
