...
function WorkspaceStats() {
  ...
  return (
      <>
        <Typography variant="h5" style={{ color: currentMode === "dark" ? "white" : "black" }}>Workspace statistics</Typography>
        <p style={{ color: currentMode === "dark" ? "white" : "black" }}> Wow! {(utilizationRate * 100).toFixed(2)}% utilisation</p>
        <Scatter
            data={{
              datasets: [
                {
