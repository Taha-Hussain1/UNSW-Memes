  ...
  return (
      <StepProvider value={fetchDmMessages}>
        {pinnedMessages.length > 0 && (
            <>
              <hr/>
              <List subheader={<ListSubheader style={{ color: currentMode === "dark" ? "white" : "black" }}>Pinned Messages</ListSubheader>}>
        ...
        <List subheader={<ListSubheader>{subheader}</ListSubheader>} style={{ width: '100%' }}>
          {!isEnd && (
              <ListItem>
                <Button style={{ color: currentMode === "dark" ? "white" : "black" }} variant="outlined" color="secondary" onClick={onPrev}>
                  Previous messages
                </Button>
              </ListItem>
          )}
          ...
          {isPaginating && (
              <ListItem>
                <Button style={{ color: currentMode === "dark" ? "white" : "black" }} variant="outlined" color="secondary" onClick={onNext}>Next messages</Button>
              </ListItem>
          )}
        </List>
