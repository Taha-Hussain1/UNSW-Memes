...
function Dm({ dmId, ...props }) {
  ...
  return (
      <>
        {loading ? <Placeholder/> : (
            <>
              <Typography style={{ color: currentMode === "dark" ? "white" : "black" }} variant="h4">{name.toUpperCase()}</Typography>
              <List subheader={<ListSubheader style={{ color: currentMode === "dark" ? "white" : "black" }}>Members</ListSubheader>}>
                              ...
                              <>
                                <Grid container alignItems="center" spacing={1}>
                                  <Grid item>
                                    ...
                                    <Typography style={{ color: currentMode === "dark" ? "white" : "black" }}>{`${nameFirst} ${nameLast}`} </Typography>
                                    </Link>
                                  </Grid>
                                </Grid>
                              </>
                ...
                <ListItem key="leave_dm">
                  <Grid container spacing={1}>
                    <Grid item>
                      <Button style={{ color: "#b2102f"}} variant="outlined" onClick={() => leaveDm(dmId, token)}>
                        Leave Dm
                      </Button>
                      &nbsp;
                      <Button style={{ color: "#b2102f"}} variant="outlined" onClick={() => removeDm(dmId, token)}>
                        Remove Dm
                      </Button>
                    </Grid>
                  </Grid>
