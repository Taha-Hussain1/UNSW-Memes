...
function ChannelList({ channelId: currChannelId }) {
  ...
  return (
      <>
        <List
            subheader={(
                <ListSubheader style={{ display: 'flex' }}>
                  <span style={{ flex: 1, color: currentMode === "dark" ? "white" : "black" }}>My Channels</span>
        ...
        <List subheader={<ListSubheader style={{ color: currentMode === "dark" ? "white" : "black" }}>Other Channels</ListSubheader>}>
